...
> You must never report security related issues, vulnerabilities or bugs including sensitive information (not that there should be) to the issue tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to [mochji](mailto:mochji@gmail.com).
